...
- Column staggering to fit the natural curvature of hands.
...
*The '^' key was not in the key analysis results.

2. This leaves the following to be assigned. Layer 1, 2, and 3 need four, four, and six additional characters respectively. Each are added according to frequency.
...
3. After adding the To keep the brackets together, they will be moved to Layer 4. Adding the pipe instead finishes off Layer 3.
[Layer 3-2]
